    ...
    <>
      ...
      {isOpen && (
        <motion.div
          ...
          animate="visible"
          exit="exit"
          ref={chatContainerRef} className="fixed bottom-24 right-4 z-[9999] bg-white rounded-lg border border-gray-200 w-[310px] sm:w-96 shadow-lg overflow-hidden transition-all duration-300 ease-in-out">
